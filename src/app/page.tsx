  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <nav className="border-b bg-white">
        <div className="container flex h-12 items-center overflow-x-auto px-4 md:px-6">
      ...
      <main className="flex-1">
        <section className="relative bg-gradient-to-b from-blue-400 to-blue-600 py-16 md:py-24">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <h3 className="text-lg font-semibold">PARCEL DELIVERY</h3>
              </div>
              <div className="flex flex-col items-center gap-2 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-white shadow-md">
                  <svg
              ...
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <h3 className="text-lg font-semibold">PACKAGING SUPPLIES</h3>
              </div>
            </div>
          </div>
        </section>
